...
final data =  FirebaseFirestore.instance.collection("cost").doc('gqMkd8eNqYd1YUkF5lMn').get().then((value){
  print(value.data());
...
class AssistantMethods{
  ...
  static calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo, int fare){

    double timeTraveledFareAmountPerMinute = (directionDetailsInfo.distance_value! / 60) * 0.1;
    double distanceTraveledFareAmountPerKilometer = (directionDetailsInfo.distance_value! / 1000) * fare;

    double localCurrencyFareAmount = distanceTraveledFareAmountPerKilometer * fare;
    return distanceTraveledFareAmountPerKilometer.toInt();
   // return double.parse(distanceTraveledFareAmountPerKilometer.toStringAsFixed(0));
  }
  ...
  static void readTripsKeysForOnlineUser(context)async
  {
