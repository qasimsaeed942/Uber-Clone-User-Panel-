...
class _MainScreenState extends State<MainScreen>
{
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          GoogleMap(
            padding: EdgeInsets.only(bottom: bottomPaddingOfMap,top: 21),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          const Icon(Icons.add_location_alt_outlined, color: Colors.yellow,),
                      ...
                      ElevatedButton(
                        child: const Text(
                          "Request a Ride",style: TextStyle(color: Colors.black54),
                        ),
                        onPressed: ()
                        {
                  ...
                  child: AnimatedTextKit(
                    animatedTexts: [
                      FadeAnimatedText(
                        ...
                        textStyle: const TextStyle(fontSize: 20.0, color: Colors.white, fontWeight: FontWeight.bold),
                      ),
                      ScaleAnimatedText(
                        'Please wait...',
                        duration: const Duration(seconds: 10),
                        textAlign: TextAlign.center,
                        textStyle: const TextStyle(fontSize: 25.0, color: Colors.white, fontFamily: 'Canterbury'),
                      ),
                    ],
                  ),
                ),
  ...
  saveRideRequestInformation() async
  {
    ...
    tripRideRequestInfoStreamSubscription = referenceRideRequest!.onValue.listen((eventSnap) async
    {
      ...
      if((eventSnap.snapshot.value as Map)["bike_details"] != null)
      {
        setState(() {
          driverCarDetails = (eventSnap.snapshot.value as Map)["bike_details"].toString();
        });
      }
    ...
    await retrieveOnlineDriversInformation(onlineNearByAvailableDriversList);
      ...
      var response = await Navigator.push(context, MaterialPageRoute(
       ...
       if(response == "driver chosen"){
         FirebaseDatabase.instance.ref().child("drivers").child(chosenDriverId!).once().then((value){
           if(value.snapshot.value != null)
           {
             ...
             {
             Fluttertoast.showToast(msg: "This driver does not exists. Please try again");
           }
         });
       }
  }
  ...
  sendNotificationToDriverNow(String chosenDriverId){
    //assign rideRequestId to
    FirebaseDatabase.instance.ref().child("drivers")
        .child(chosenDriverId!).child("newRideStatus").set(referenceRideRequest!.key);
